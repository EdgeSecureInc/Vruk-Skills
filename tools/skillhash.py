...
Dotfiles and dot-directories are skipped. The same algorithm must be used by
any consumer (installer, scanner, mothership) that wants to answer "has this
skill changed since it was installed?".
